...
class Product(models.Model):
    ...
    price_product = models.DecimalField(max_digits=10, decimal_places=2, default=0)
    ...
    @property
    def total(self):
        return sum(item.price_product * item.quantity_product for item in self.itens.all())
